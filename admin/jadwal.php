                ...
                <div class="col-lg-12 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <a class="btn btn-success mb-2" href="tambahjadwal.php">Ajukan Jadwal Seminar</a>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            href="proses_selesai_seminar.php?id=<?= $data['id'] ?>" 
                                            onclick="return confirm('Apakah Anda yakin seminar ini telah selesai?')">
                                                <i class="fas fa-check"></i> Selesai
                                            </a>
                                            <a class="btn btn-warning btn-sm" 
                                            href="proses_tunda_seminar.php?id=<?= $data['id'] ?>" 
                                            onclick="return confirm('Apakah Anda yakin ingin menunda seminar ini?')">
                                                <i class="fas fa-clock"></i> Tunda
                                            </a>
                                            <?php elseif ($data['status'] == 'Ditunda'): ?>
                                            <a class="btn btn-primary btn-sm" 
                                            href="proses_dijadwalkan_seminar.php?id=<?= $data['id'] ?>" 
                                            onclick="return confirm('Apakah Anda yakin ingin menunda seminar ini?')">
                                                <i class="fas fa-clock"></i> Jadwalkan Ulang
                                            </a>
                                            <?php endif; ?>
                                            
                                            <?php if($data['status'] == 'Selesai'): ?>
                                            <a class="btn btn-info btn-sm" 
                                            href="nilai_seminar.php?id=<?= $data['id'] ?>">
